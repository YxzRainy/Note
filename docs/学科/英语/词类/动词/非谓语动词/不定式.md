...
不定式表「**现在没有做，将要去做，突出接下来的打算；目的；意料之外的结果**；假设、未实现或未来的状态」，但并不是时态。  
...
**使役动词（make 等）与感官动词（see等）后接复合宾语时候，作宾补的不定式需要省略 to ，**help 既可以接 to do ，也可省略其中的 to。

主动语态中，省略 to，被动语态中，还原 to。

### 固定结构

「It is + adj + for sb to do sth」，表对某人来说做某事是怎么样的。
