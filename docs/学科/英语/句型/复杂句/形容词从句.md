...
which 或 whom 充当介词的宾语，介词可提到从句之前，但固定的介词短语不能提前。
...
| -------- | -------------- | --------------------------- |
| when     | 时间名词       | 作时间状语 $=$ prep + which |
| where    | 地点名词       | 作地点状语 $=$ prep + which |
| why      | 原因名词       | 作原因状语 $=$ for + which  |
...
从句和先行词之间关系不是很密切，从句仅是对先行词的附加说明，若去掉从句，整个句子的意思依旧完整。
